...
class MyModel(nn.Module):
    def __init__(self,num_filters,kernel_size,dropout_rate,n11,n21,n31,n32,n41,n42,n43\
        ...
        self.conv1d = nn.Conv1d(in_channels=36, out_channels=num_filters, kernel_size=kernel_size, stride=1, padding='same')
...
def objective(trial):
    ...
    D = 36 # This should be set to the actual number of channels/features in your input data
